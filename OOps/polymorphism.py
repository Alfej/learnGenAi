...
class ManualCar(Car):
    ...
    # Static polymorphism example, With different number of arguments we are able to call the same method name
    # we can also achieve this using default arguments
...
if __name__ == "__main__":
    ...
    print(my_manual_car.accelerate(20))
